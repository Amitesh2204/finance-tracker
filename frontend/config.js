...
(function () {
  ...
  window.__CONFIG__ = {
    couchHost: 'coalition-stockholm-strengthening-bishop.trycloudflare.com', // replace with your tunnel host
    couchDbName: 'finance',
  ...
  window.__USERS_COUCH__ = window.__USERS_COUCH__ || 'https://admin:Winter_2026@coalition-stockholm-strengthening-bishop.trycloudflare.com/finance-users';
})();
