...
(function () {
  ...
  window.__CONFIG__ = {
    couchHost: 'mild-phi-accuracy-habitat.trycloudflare.com', // replace with your tunnel host
    couchDbName: 'finance',
  ...
  window.__USERS_COUCH__ = window.__USERS_COUCH__ || 'https://admin:Winter_2026@YOUR_TUNNEL_HOST/finance-users';
})();
