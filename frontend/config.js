...
(function () {
  ...
  window.__CONFIG__ = {
    couchHost: 'bool-harry-scores-twins.trycloudflare.com', // replace with your tunnel host
    couchDbName: 'finance',
  ...
  window.__USERS_COUCH__ = window.__USERS_COUCH__ || 'https://admin:bool-harry-scores-twins.trycloudflare.com/finance-users';
})();