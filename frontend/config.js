...
(function () {
  ...
  window.__CONFIG__ = {
    couchHost: 'richards-franklin-watershed-leo.trycloudflare.com', // replace with your tunnel host
    couchDbName: 'finance',
  ...
  window.__USERS_COUCH__ = window.__USERS_COUCH__ || 'https://admin:richards-franklin-watershed-leo.trycloudflare.com/finance-users';
})();