...
(function () {
  ...
  window.__CONFIG__ = {
    couchHost: 'employees-stopping-chemicals-liver.trycloudflare.com', // replace with your tunnel host
    couchDbName: 'finance',
  ...
  window.__USERS_COUCH__ = window.__USERS_COUCH__ || 'https://admin:employees-stopping-chemicals-liver.trycloudflare.com/finance-users';
})();
