...
(function () {
  ...
  window.__CONFIG__ = {
    couchHost: 'friendly-explosion-bid-calgary.trycloudflare.com', // replace with your tunnel host
    couchDbName: 'finance',
  ...
  window.__USERS_COUCH__ = window.__USERS_COUCH__ || 'https://admin:friendly-explosion-bid-calgary.trycloudflare.com/finance-users';
})();