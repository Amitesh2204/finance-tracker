...
(function () {
  ...
  window.__CONFIG__ = {
    couchHost: 'definitely-specifies-popular-lowest.trycloudflare.com', // replace with your tunnel host
    couchDbName: 'finance',
  ...
  window.__USERS_COUCH__ = window.__USERS_COUCH__ || 'https://admin:Winter_2026@definitely-specifies-popular-lowest.trycloudflare.com/finance-users';
})();
