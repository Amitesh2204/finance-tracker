...
(function () {
  ...
  window.__CONFIG__ = {
    couchHost: 'fiscal-noon-mathematics-arrangements.trycloudflare.com', // replace with your tunnel host
    couchDbName: 'finance',
  ...
  window.__USERS_COUCH__ = window.__USERS_COUCH__ || 'https://admin:Winter_2026@fiscal-noon-mathematics-arrangements.trycloudflare.com/finance-users';
})();
