...
(function () {
  ...
  window.__CONFIG__ = {
    couchHost: 'bios-bike-colored-firmware.trycloudflare.com', // replace with your tunnel host
    couchDbName: 'finance',
  ...
  window.__USERS_COUCH__ = window.__USERS_COUCH__ || 'https://admin:bios-bike-colored-firmware.trycloudflare.com/finance-users';
})();