...
(function () {
  ...
  window.__CONFIG__ = {
    couchHost: 'buzz-academy-cigarettes-earning.trycloudflare.com', // replace with your tunnel host
    couchDbName: 'finance',
  ...
  window.__USERS_COUCH__ = window.__USERS_COUCH__ || 'https://admin:Winter_2026@buzz-academy-cigarettes-earning.trycloudflare.com/finance-users';
})();
