...
(function () {
  ...
  window.__CONFIG__ = {
    couchHost: 'rendering-enlarge-locks-useful.trycloudflare.com', // replace with your tunnel host
    couchDbName: 'finance',
  ...
  window.__USERS_COUCH__ = window.__USERS_COUCH__ || 'https://admin:rendering-enlarge-locks-useful.trycloudflare.com/finance-users';
})();
