...
(function () {
  ...
  window.__CONFIG__ = {
    couchHost: 'supports-chairs-boring-thing.trycloudflare.com', // replace with your tunnel host
    couchDbName: 'finance',
  ...
  window.__USERS_COUCH__ = window.__USERS_COUCH__ || 'https://admin:Winter_2026@supports-chairs-boring-thing.trycloudflare.com/finance-users';
})();
