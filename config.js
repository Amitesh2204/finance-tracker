...
(function () {
  ...
  window.__CONFIG__ = {
    couchHost: 'applications-catalog-represented-colleagues.trycloudflare.com', // replace with your tunnel host
    couchDbName: 'finance',
  ...
  window.__USERS_COUCH__ = window.__USERS_COUCH__ || 'https://admin:applications-catalog-represented-colleagues.trycloudflare.com/finance-users';
})();
