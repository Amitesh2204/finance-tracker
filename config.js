...
(function () {
  ...
  window.__CONFIG__ = {
    couchHost: 'maximize-theatre-extensions-developments.trycloudflare.com', // replace with your tunnel host
    couchDbName: 'finance',
  ...
  window.__USERS_COUCH__ = window.__USERS_COUCH__ || 'https://admin:maximize-theatre-extensions-developments.trycloudflare.com/finance-users';
})();